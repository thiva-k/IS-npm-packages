...
import { GenericIcon, Media, Message } from "@thiva/react-components";
 ...
 * @deprecated Use the `SectionProps` from {@link @thiva/react-components#SectionProps}.
 */
 ...
 *
 * @deprecated Use the `Section` from {@link @thiva/react-components#Section}.
