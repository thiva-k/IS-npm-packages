...
import { Show, useRequiredScopes } from "@thiva/access-control";
import { IdentityAppsApiException } from "@thiva/core/exceptions";
import { resolveUserstore } from "@thiva/core/helpers";
...
import { UIConstants } from "@thiva/admin.core.v1/constants/ui-constants";
import { FeatureConfigInterface } from "@thiva/admin.core.v1/models/config";
import { AppState } from "@thiva/admin.core.v1/store";
import {
    updateApplicationRoleMappedGroups,
    useApplicationRoleMappedGroups
} from "@thiva/admin.extensions.v1/components/application/api";
import {
    ApplicationRoleGroupInterface,
    ApplicationRoleGroupsUpdatePayloadInterface
} from "@thiva/admin.extensions.v1/components/application/models";
