...
import { EmptyPlaceholder, PageLayout, PrimaryButton } from "@thiva/react-components";
import React, {
    FunctionComponent,
    MouseEvent,
    ReactElement,
...
import { OutboundProvisioningConfigurationInterface } from "@thiva/admin.applications.v1/models/application";
import { OutboundProvisioningConnectorInterface } from "@thiva/admin.connections.v1/models/connection";
import {
    AppConstants,
    AppState,
...
import { IdentityProviderInterface } from "@thiva/admin.identity-providers.v1/models/identity-provider";
