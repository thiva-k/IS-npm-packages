...
import { ApplicationTemplatesConfigInterface } from "@thiva/admin.applications.v1/data/application-templates";
import {
    IdentityProviderTemplatesConfigInterface
} from "@thiva/admin.identity-providers.v1/data/identity-provider-templates";
