...
import { Heading, Text } from "@thiva/react-components";
...
import { getApplicationTemplateIllustrations } from "@thiva/admin.applications.v1/configs/ui";
import CustomApplicationTemplate from
    "@thiva/admin.applications.v1/data/application-templates/templates/custom-application/custom-application.json";
import {
...
import { AppConstants, AppState, EventPublisher, history } from "@thiva/admin.core.v1";
