...
import BuildLoginFlowIllustration from
    "@thiva/admin.connections.v1/components/authenticators/fido/assets/build-login-flow.png";
import ConfigureParametersIllustration from
    "@thiva/admin.connections.v1/components/authenticators/fido/assets/configure-parameters.png";
