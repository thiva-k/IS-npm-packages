...
import { FeatureAccessConfigInterface, LegacyModeInterface, RouteInterface } from "@thiva/core/models";
...
import { APIResourcesConstants } from "@thiva/admin.api-resources.v1/constants";
import { commonConfig } from "@thiva/admin.extensions.v1/configs/common";
import { identityProviderConfig } from "@thiva/admin.extensions.v1/configs/identity-provider";
import { FeatureGateConstants } from "@thiva/admin.extensions.v1/components/feature-gate/constants/feature-gate";
import { AppLayout, AuthLayout, DefaultLayout, ErrorLayout } from "@thiva/admin.layouts.v1";
import { ServerConfigurationsConstants } from "@thiva/admin.server-configurations.v1";
import { AppView, FullScreenView } from "@thiva/admin.views.v1";
...
export const getAppViewRoutes = (): RouteInterface[] => {
    ...
    const defaultRoutes: RouteInterface[] = [
        {
            component: lazy(() =>
                import("@thiva/admin.extensions.v1/components/getting-started/getting-started")),
            exact: false,
            icon: {
        ...
        },
        {
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.session-management.v1/pages/session-management")),
                    exact: true,
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.saml2-configuration.v1/pages/saml2-configuration")),
                    exact: true,
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.wsfed-configuration.v1/pages/wsfed-configuration")),
                    exact: true,
                ...
                },
                {
                    component: lazy(() =>
                        import(
                            "@thiva/admin.server-configurations.v1/" +
                ...
                },
                {
                    component: lazy(() =>
                        import(
                            "@thiva/admin.extensions.v1/components/account-login/" +
            ...
            component: lazy(() =>
                import(
                    "@thiva/admin.server-configurations.v1/pages/connector-listing-page"
                )
            ),
            exact: false,
            icon: {
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() => import("@thiva/admin.applications.v1/pages/application-template")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
                ...
                {
                    component: lazy(() => import("@thiva/admin.applications.v1/pages/application-edit")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
            ...
            component: lazy(() => import("@thiva/admin.applications.v1/pages/applications")),
            exact: true,
            icon: {
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() => import("@thiva/admin.users.v1/pages/user-edit")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
            ...
            component: lazy(() => import("@thiva/admin.users.v1/pages/users")),
            exact: true,
            icon: {
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.groups.v1/pages/group-edit")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
            ...
            component: lazy(() => import("@thiva/admin.groups.v1/pages/groups")),
            exact: true,
            icon: {
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.connections.v1/pages/connection-templates")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.connections.v1/pages/connection-edit")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
            ...
            component: lazy(() => import("@thiva/admin.connections.v1/pages/connections")),
            exact: true,
            icon: {
                icon: <NodesIcon />
            },
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.identity-verification-providers.v1/pages/" +
                ...
                },
                {
                    component: lazy(() => import(
                        "@thiva/admin.identity-verification-providers.v1/pages/" +
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() => import("@thiva/admin.claims.v1/pages/local-claims-edit")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
                ...
                {
                    component: lazy(() => import("@thiva/admin.claims.v1/pages/local-claims")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
                ...
                {
                    component: lazy(() => import("@thiva/admin.claims.v1/pages/external-dialect-edit")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
                ...
                {
                    component: lazy(() => import("@thiva/admin.claims.v1/pages/attribute-mappings")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
                ...
                {
                    component: lazy(() => import("@thiva/admin.claims.v1/pages/" +
            ...
            component: lazy(() => import("@thiva/admin.claims.v1/pages/claim-dialects")),
            exact: true,
            icon: {
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() => import("@thiva/admin.oidc-scopes.v1/pages/oidc-scopes-edit")),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                    },
            ...
            component: lazy(() => import("@thiva/admin.oidc-scopes.v1/pages/oidc-scopes")),
            exact: true,
            icon: {
        ...
        },
        {
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.organizations.v1/pages/organization-edit")
                    ),
                    exact: true,
                    icon: {
            ...
            component: lazy(() => import("@thiva/admin.organizations.v1/pages/organizations")),
            exact: true,
            icon: {
                icon: <BuildingIcon />
            },
        ...
        },
        {
            children: [
                {
                    component: lazy(() => {
                        ...
                        return import("@thiva/admin.organization-discovery.v1/pages/assign-organization-discovery-domains-page");
                    }),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().organization
                ...
                },
                {
                    component: lazy(() => {
                        // eslint-disable-next-line max-len
                        return import("@thiva/admin.organization-discovery.v1/pages/edit-organization-discovery-domains-page");
                    }),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().organization
            ...
            component: lazy(() => {
                return import("@thiva/admin.organization-discovery.v1/pages/" +
        ...
        },
        {
            ...
            component: lazy(() => import("@thiva/admin.branding.v1/pages/branding")),
            exact: true,
            icon: {
                icon: import("@thiva/admin.extensions.v1/assets/images/icons/" +
        ...
        },
        {
            category: "extensions:develop.sidePanel.categories.branding",
            component: lazy(() =>
                import("@thiva/admin.email-management.v1/" + "pages/email-customization")
            ),
            exact: true,
        ...
        },
        {
            category: "extensions:develop.sidePanel.categories.branding",
            component: lazy(() =>
                import("@thiva/admin.email-and-sms.v1/" + "pages/email-and-sms")
            ),
            exact: true,
        ...
        },
        {
            category: "extensions:develop.sidePanel.categories.branding",
            component: lazy(() =>
                import("@thiva/admin.email-providers.v1" + "/pages/email-providers")
            ),
            exact: true,
            icon: {
        ...
        },
        {
            ...
            component: lazy(() =>
                import("@thiva/admin.sms-providers.v1" + "/pages/sms-providers")
            ),
            exact: true,
            icon: {
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.extensions.v1/components/" + "my-account/pages/my-account-edit")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
            ...
            component: lazy(() => import("@thiva/admin.extensions.v1/components/my-account/pages/" +
                "my-account")),
            exact: true,
            icon: {
                icon: import("@thiva/admin.extensions.v1/assets/images/icons/self-service-portal-icon.svg")
            },
            id: "myAccount",
            ...
            children: [
                {
                    component: lazy(() =>
                        import(
                            "@thiva/admin.server-configurations.v1/pages/connector-edit-page"
                        )
                    ),
                    exact: true,
                    icon: {
        ...
        },
        {
            ...
            children: [
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.validation.v1/pages/validation-config-edit")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().organization
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.private-key-jwt.v1/pages/private-key-jwt-config-edit")
                    ),
                    exact: true,
                    icon: {
        ...
        },
        {
            ...
            component: lazy(() => import("@thiva/admin.extensions.v1/components/logs/pages/logs")),
            exact: true,
            featureGateIds: [ FeatureGateConstants.SAAS_FEATURES_IDENTIFIER ],
            icon: {
                icon: import("@thiva/admin.extensions.v1/assets/images/icons/event-publishing.svg")
            },
            id: "logs",
        ...
        {
            category: "extensions:develop.sidePanel.categories.monitor",
            component: lazy(() => import("@thiva/admin.org-insights.v1/pages/org-insights")),
            exact: true,
            featureGateIds: [ FeatureGateConstants.SAAS_FEATURES_IDENTIFIER ],
            featureStatus: "BETA",
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.server.v1/pages/admin-session-advisory-banner-page")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.server.v1/pages/remote-logging-page")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.server.v1/pages/internal-notification-sending-page")
                    ),
                    exact: true,
                    icon: {
                        icon: getSidePanelIcons().childIcon
            ...
            component: lazy(() =>
                import(
                    "@thiva/admin.server.v1/pages/server"
                )
            ),
            exact: true,
            icon: {
        ...
        {
            category: "extensions:manage.sidePanel.categories.userManagement",
            component: lazy(() => import("@thiva/admin.workflow-approvals.v1/pages/approvals")),
            exact: true,
            icon: {
        ...
        },
        {
            ...
            component: lazy(() => import("@thiva/admin.certificates.v1/pages/certificates-keystore")),
            icon: {
        ...
        },
        {
            ...
            children: [
                {
                    component: lazy(() => import("@thiva/admin.secrets.v1/pages/secret-edit")),
                    exact: false,
            ...
            component: lazy(() => import("@thiva/admin.secrets.v1/pages/secrets")),
            exact: true,
        ...
        },
        {
            children: [
                {
                    component: lazy(() => import("@thiva/admin.console-settings.v1/pages/" +
                ...
                {
                    component: lazy(() => {
                        return import("@thiva/admin.console-settings.v1/pages/" +
            ...
            component: lazy(() => import("@thiva/admin.console-settings.v1/pages/console-settings-page")),
            exact: true,
            icon: {
        ...
        // the following routes are not onboarded to the side panel
        {
            ...
            component: lazy(() =>
                import("@thiva/admin.remote-repository-configuration.v1/pages/remote-repository-config")
            ),
            exact: true,
            icon: {
        ...
        {
            component: lazy(() => import("@thiva/admin.server-configurations.v1/pages/" +
    ...
    if (legacyMode?.apiResourcesV1) {
        defaultRoutes.unshift({
            ...
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.api-resources.v1/pages/api-resource-edit")
                    ),
                    exact: true,
            ...
            component: lazy(() =>
                import("@thiva/admin.api-resources.v1/pages/api-resources")
            ),
            exact: true,
            icon: {
    ...
    if (legacyMode?.apiResourcesV2) {
        defaultRoutes.unshift({
            ...
            children: [
                {
                    component: lazy(() =>
                        import("@thiva/admin.api-resources.v2/pages/api-resource-edit")
                    ),
                    exact: true,
                    id: "apiResources-edit",
                    name: "extensions:develop.sidePanel.apiResources",
                ...
                {
                    component: lazy(() =>
                        import("@thiva/admin.api-resources.v2/pages/api-resources-internal-list")
                    ),
                    exact: true,
            ...
            component: lazy(() =>
                import("@thiva/admin.api-resources.v2/pages/api-resources")
            ),
            exact: true,
            icon: {
                icon: getSidePanelIcons().apiResources
        ...
        defaultRoutes.push(
            {
                ...
                children: [
                    {
                        component: lazy(() => import("@thiva/admin.roles.v1/pages/role-edit")),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                ...
                component: lazy(() => import("@thiva/admin.roles.v1/pages/role")),
                exact: true,
                icon: {
        ...
        defaultRoutes.push(
            {
                ...
                children: [
                    {
                        component: lazy(() => import("@thiva/admin.roles.v2/pages/role-edit")),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                    ...
                    {
                        component: lazy(() => import("@thiva/admin.roles.v2/pages/create-role-wizard")),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                        },
                ...
                component: lazy(() => import("@thiva/admin.roles.v2/pages/role")),
                exact: true,
                icon: {
                    icon: getSidePanelIcons().applicationRoles
                },
        ...
        defaultRoutes.push(
            {
                ...
                children: [
                    {
                        component: lazy(() =>
                            import("@thiva/admin.extensions.v1/components/groups/pages/groups-edit")
                        ),
                        exact: true,
                        icon: {
                            icon: getSidePanelIcons().childIcon
                ...
                component: lazy(() => import("@thiva/admin.extensions.v1/components/groups/pages/groups")),
                exact: true,
                icon: {
                    icon: <UserGroupIcon className="icon" fill="black" />
                },
...
export const getAuthLayoutRoutes = (): RouteInterface[] => {
    const routes: RouteInterface[] = [
        {
            component: lazy(() => import("@thiva/admin.extensions.v1/components/tenants/pages/create-tenant")),
            exact: true,
            icon: null,
            id: "createTenant",
            name: "createTenant",
        ...
        {
            component: lazy(() => import("@thiva/admin.authentication.v1/pages/sign-out")),
            icon: null,
            id: "authLayoutLogout",
            name: "Logout",
