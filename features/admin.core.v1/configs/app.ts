...
import { DocumentationConstants } from "@thiva/core/constants";
import { DocumentationProviders, DocumentationStructureFileTypes } from "@thiva/core/models";
import { I18nModuleInitOptions, I18nModuleOptionsInterface, MetaI18N, generateBackendPaths } from "@thiva/i18n";
import { getAPIResourceEndpoints } from "@thiva/admin.api-resources.v2/configs/endpoint";
import { getApplicationsResourceEndpoints } from "@thiva/admin.applications.v1/configs/endpoints";
import isLegacyAuthzRuntime from "@thiva/admin.authorization.v1/utils/get-legacy-authz-runtime";
import { getBrandingResourceEndpoints } from "@thiva/admin.branding.v1/configs/endpoints";
import { getCertificatesResourceEndpoints } from "@thiva/admin.certificates.v1";
import { getClaimResourceEndpoints } from "@thiva/admin.claims.v1/configs/endpoints";
import { getConnectionResourceEndpoints } from "@thiva/admin.connections.v1";
import { getConsoleSettingsResourceEndpoints } from "@thiva/admin.console-settings.v1/configs/endpoints";
import { getEmailTemplatesResourceEndpoints } from "@thiva/admin.email-templates.v1";
import { getFeatureGateResourceEndpoints } from "@thiva/admin.extensions.v1/components/feature-gate/configs";
import { getExtendedFeatureResourceEndpoints } from "@thiva/admin.extensions.v1/configs/endpoints";
import { getExtendedFeatureResourceEndpointsV2 } from "@thiva/admin.extensions.v2/config/endpoints";
import { getGroupsResourceEndpoints } from "@thiva/admin.groups.v1";
import { getIDPResourceEndpoints } from "@thiva/admin.identity-providers.v1/configs/endpoints";
import { getIDVPResourceEndpoints } from "@thiva/admin.identity-verification-providers.v1";
import { getScopesResourceEndpoints } from "@thiva/admin.oidc-scopes.v1";
import { getInsightsResourceEndpoints } from "@thiva/admin.org-insights.v1/config/org-insights";
import { getOrganizationsResourceEndpoints } from "@thiva/admin.organizations.v1/configs";
import { OrganizationUtils } from "@thiva/admin.organizations.v1/utils";
import { getJWTAuthenticationServiceEndpoints } from "@thiva/admin.private-key-jwt.v1/configs";
import { getRemoteFetchConfigResourceEndpoints } from "@thiva/admin.remote-repository-configuration.v1";
import { getRolesResourceEndpoints } from "@thiva/admin.roles.v2/configs/endpoints";
import { getSecretsManagementEndpoints } from "@thiva/admin.secrets.v1/configs/endpoints";
import { getServerConfigurationsResourceEndpoints } from "@thiva/admin.server-configurations.v1";
import { getTenantResourceEndpoints } from "@thiva/admin.tenants.v1/configs/endpoints";
import { getUsersResourceEndpoints } from "@thiva/admin.users.v1/configs/endpoints";
import { getUserstoreResourceEndpoints } from "@thiva/admin.userstores.v1/configs/endpoints";
import { getValidationServiceEndpoints } from "@thiva/admin.validation.v1/configs";
import { getApprovalsResourceEndpoints } from "@thiva/admin.workflow-approvals.v1";
