...
import { BrandingPreferenceResourceEndpointsInterface } from "@thiva/admin.branding.v1/models/endpoints";
import { CertificatesResourceEndpointsInterface } from "@thiva/admin.certificates.v1";
import { ClaimResourceEndpointsInterface } from "@thiva/admin.claims.v1/models/endpoints";
import { ConsoleSettingsResourceEndpointsInterface } from "@thiva/admin.console-settings.v1/models/endpoints";
import { GroupsResourceEndpointsInterface } from "@thiva/admin.groups.v1";
import { IDPResourceEndpointsInterface } from "@thiva/admin.identity-providers.v1/models/endpoints";
import { IdentityProviderTemplateLoadingStrategies } from "@thiva/admin.identity-providers.v1/models/identity-provider";
import { ScopesResourceEndpointsInterface } from "@thiva/admin.oidc-scopes.v1";
import { OrganizationResourceEndpointsInterface } from "@thiva/admin.organizations.v1/models";
import { JWTAuthenticationServiceEndpointsInterface } from "@thiva/admin.private-key-jwt.v1/models";
import { RolesResourceEndpointsInterface } from "@thiva/admin.roles.v2/models/endpoints";
import { SecretsManagementEndpoints } from "@thiva/admin.secrets.v1/models/endpoints";
import { ServerConfigurationsResourceEndpointsInterface } from "@thiva/admin.server-configurations.v1";
import { TenantResourceEndpointsInterface } from "@thiva/admin.tenants.v1/models/endpoints";
import { UsersResourceEndpointsInterface } from "@thiva/admin.users.v1/models/endpoints";
import { UserstoreResourceEndpointsInterface } from "@thiva/admin.userstores.v1/models/endpoints";
import { ValidationServiceEndpointsInterface } from "@thiva/admin.validation.v1/models";
