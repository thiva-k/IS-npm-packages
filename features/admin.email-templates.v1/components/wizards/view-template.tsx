...
import { ContentLoader, Heading, LinkButton, PrimaryButton } from "@thiva/react-components";
    ...
    return (
        ...
        >
            <Modal.Header className="wizard-header template-type-wizard">
                ...
                <Heading as="h6">
                    { t("emailTemplates:viewTemplate.heading") }
                </Heading>
            </Modal.Header>
                ...
                <Grid>
                    <Grid.Row column={ 1 }>
                        ...
                        <Grid.Column mobile={ 8 } tablet={ 8 } computer={ 8 }>
                            ...
                            >
                                { t("emailTemplates:buttons.editTemplate") }
                            </PrimaryButton>
                        </Grid.Column>
                    </Grid.Row>
                </Grid>
