...
import { EmphasizedSegment } from "@thiva/react-components";
...
import { useGroupList } from "@thiva/admin.groups.v1/api/groups";
import { GroupsInterface } from "@thiva/admin.groups.v1/models/groups";
import { IdentityProviderGroupInterface } from "@thiva/admin.identity-providers.v1/models";
...
EditRoleLocalGroupsAccordion.defaultProps = {
    "data-componentid": "edit-role-local-groups",
    isReadOnly: false
};
