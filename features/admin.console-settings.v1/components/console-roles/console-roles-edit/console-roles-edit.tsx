...
import { OrganizationType } from "@thiva/admin.core.v1";
import { RoleConstants } from "@thiva/core/constants";
import { hasRequiredScopes } from "@thiva/core/helpers";
import { FeatureAccessConfigInterface, IdentifiableComponentInterface, RolesInterface } from "@thiva/core/models";
import { ResourceTab, ResourceTabPaneInterface } from "@thiva/react-components";
...
import { BasicRoleDetails } from "@thiva/admin.roles.v2/components/edit-role/edit-role-basic";
import { RoleConnectedApps } from "@thiva/admin.roles.v2/components/edit-role/edit-role-connected-apps";
import { RoleGroupsList } from "@thiva/admin.roles.v2/components/edit-role/edit-role-groups";
import { RoleUsersList } from "@thiva/admin.roles.v2/components/edit-role/edit-role-users";
import { RoleAudienceTypes } from "@thiva/admin.roles.v2/constants/role-constants";
