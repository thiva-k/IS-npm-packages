...
import { ApplicationInterface, AuthenticationSequenceInterface } from "@thiva/admin.applications.v1/models/application";
import { OIDCDataInterface } from "@thiva/admin.applications.v1/models/application-inbound";
