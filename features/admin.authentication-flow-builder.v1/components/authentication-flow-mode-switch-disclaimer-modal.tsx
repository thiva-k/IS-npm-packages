...
import { ConfirmationModal, ConfirmationModalPropsInterface } from "@thiva/react-components";
...
> = (
    ...
    return (
        <ConfirmationModal
            ...
            assertionHint={ t("authenticationFlow:modes.switchConfirmationModal.assertionHint") }
            assertionType="checkbox"
            primaryAction={ t("authenticationFlow:modes.switchConfirmationModal.primaryActionButtonText") }
            secondaryAction={ t("authenticationFlow:modes.switchConfirmationModal.secondaryActionButtonText") }
        ...
        >
            <ConfirmationModal.Header data-componentid={ `${componentId}-header` }>
                { t("authenticationFlow:modes.switchConfirmationModal.title") }
            ...
            >
                <Trans
                    i18nKey="authenticationFlow:modes.switchConfirmationModal.warningMessage"
            ...
            <ConfirmationModal.Content data-componentid={ `${componentId}-content` }>
                { t("authenticationFlow:modes.switchConfirmationModal.content") }
