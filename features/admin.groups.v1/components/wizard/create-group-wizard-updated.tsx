...
import { hasRequiredScopes, isFeatureEnabled } from "@thiva/core/helpers";
import {
    AlertLevels,
...
import { AppConstants, AppState, AssignRoles, RolePermissions, history } from "@thiva/admin.core.v1";
import { EventPublisher } from "@thiva/admin.core.v1/utils";
import { commonConfig } from "@thiva/admin.extensions.v1/configs";
import { getOrganizationRoles } from "@thiva/admin.organizations.v1/api";
import { OrganizationRoleManagementConstants } from "@thiva/admin.organizations.v1/constants";
...
} from "@thiva/admin.organizations.v1/models";
import { getRolesList, updateRole } from "@thiva/admin.roles.v2/api";
import { RoleConstants } from "@thiva/admin.roles.v2/constants";
import {
    BasicRoleInterface,
    PatchRoleDataInterface,
    RolesV2Interface,
    RolesV2ResponseInterface
} from "@thiva/admin.roles.v2/models";
import { UserBasicInterface } from "@thiva/admin.users.v1/models";
import { CONSUMER_USERSTORE, PRIMARY_USERSTORE } from "@thiva/admin.userstores.v1/constants";
