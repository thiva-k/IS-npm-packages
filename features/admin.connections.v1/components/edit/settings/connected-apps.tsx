...
import { OrganizationType } from "@thiva/admin.core.v1/constants/organization-constants";
...
import { applicationListConfig } from "@thiva/admin.extensions.v1/configs/application-list";
import { getApplicationDetails } from "@thiva/admin.applications.v1/api";
...
} from "@thiva/admin.applications.v1/utils/application-template-management-utils";
import { ConsoleSettingsModes } from "@thiva/admin.console-settings.v1/models/ui";
import {
    AppConstants,
    AppState,
