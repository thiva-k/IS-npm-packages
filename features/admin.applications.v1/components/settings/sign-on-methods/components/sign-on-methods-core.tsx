...
import { AlertLevels, IdentifiableComponentInterface, SBACInterface } from "@thiva/core/models";
import { addAlert } from "@thiva/core/store";
import { LocalStorageUtils } from "@thiva/core/utils";
import { Code, ConfirmationModal, ContentLoader, LabeledCard, Text } from "@thiva/react-components";
...
import AuthenticationFlowBuilder
    from "@thiva/admin.authentication-flow-builder.v1/components/authentication-flow-builder";
import AuthenticationFlowProvider
    from "@thiva/admin.authentication-flow-builder.v1/providers/authentication-flow-provider";
import { ConnectionsManagementUtils }
    from "@thiva/admin.connections.v1/utils/connection-utils";
import { AppConstants, EventPublisher, FeatureConfigInterface, history } from "@thiva/admin.core.v1";
import useUIConfig from "@thiva/admin.core.v1/hooks/use-ui-configs";
import {
    AuthenticatorCreateWizardFactory
} from "@thiva/admin.identity-providers.v1/components/wizards/authenticator-create-wizard-factory";
import {
...
import MicrosoftIDPTemplate
    from
    "@thiva/admin.identity-providers.v1/data/identity-provider-templates/templates/microsoft/microsoft.json";
import {
