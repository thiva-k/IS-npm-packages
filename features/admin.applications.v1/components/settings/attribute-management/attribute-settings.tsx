...
import { ConfirmationModal, ContentLoader, EmphasizedSegment } from "@thiva/react-components";
...
import { getAllExternalClaims, getAllLocalClaims, getDialects } from "@thiva/admin.claims.v1/api";
...
import { SubjectAttributeListItem } from "@thiva/admin.identity-providers.v1/components/settings";
import { useOIDCScopesList } from "@thiva/admin.oidc-scopes.v1/api/oidc-scopes";
import {
    OIDCScopesClaimsListInterface,
    OIDCScopesListInterface
} from "@thiva/admin.oidc-scopes.v1/models/oidc-scopes";
