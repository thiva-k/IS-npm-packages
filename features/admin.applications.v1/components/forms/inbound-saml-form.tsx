...
import { CheckboxChild, DropdownChild, Field, FormValue, Forms, Validation, useTrigger } from "@thiva/forms";
import { Code, CopyInputField, Heading, Hint, StickyBar, URLInput } from "@thiva/react-components";
...
import { getAvailableNameIDFormats } from "@thiva/admin.identity-providers.v1/components/utils/saml-idp-utils";
import {
                        ...
                        <Grid.Row columns={ 1 }>
                            <Grid.Column mobile={ 16 } tablet={ 16 } computer={ 16 }>
                                ...
                                <Hint>
                                    <Trans
                                        i18nKey={
                                            "applications:forms.inboundSAML.fields." +
                                            "issuer.hint"
                                        }
                                    >
