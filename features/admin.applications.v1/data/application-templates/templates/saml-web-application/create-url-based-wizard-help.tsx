 ...
 */
const SAMLWebApplicationURLBasedCreateWizardHelp: FunctionComponent<
 ...
 */
SAMLWebApplicationURLBasedCreateWizardHelp.defaultProps = {
    "data-testid": "saml-web-app-url-based-create-wizard-help"
};
 ...
 */
export default SAMLWebApplicationURLBasedCreateWizardHelp;
