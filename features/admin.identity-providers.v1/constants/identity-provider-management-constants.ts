...
import SweIdpTemplate from "@thiva/admin.extensions.v1/identity-provider-templates/templates/swe/swe.json";
import TrustedTokenIssuerTemplate from
    "@thiva/admin.extensions.v1/identity-provider-templates/templates/trusted-token-issuer/trusted-token-issuer.json";
